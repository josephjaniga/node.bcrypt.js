...
/// @param {String} [minor] ?? (default 'b')
/// @return {String} salt
module.exports.genSaltSync = function genSaltSync(rounds, minor, saltBytes) {

    var saltBytes = saltBytes || crypto.randomBytes(16);
    ...
    return bindings.gen_salt_sync(minor, rounds, saltBytes);
};
